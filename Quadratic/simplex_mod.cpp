...
int main()
{
	Simplex prev(6, 22);
	{
		...
		prev.coeff(1, 5.000000);		prev.coeff(2, 3.000000);		prev.coeff(3, 1.000000);		prev.coeff(4, 1.000000);		prev.coeff(5, 2.000000);		prev.coeff(6, 2.000000);		prev.coeff(7, -2.000000);		prev.coeff(8, -2.000000);		prev.coeff(9, 1.000000);		prev.coeff(10, -1.000000);		prev.coeff(11, -1.000000);		prev.coeff(12, -1.000000);		prev.coeff(13, 1.000000);		prev.coeff(14, 1.000000);		prev.coeff(15, 1.000000);		prev.coeff(16, 1.000000);		prev.coeff(17, 0.000000);		prev.coeff(18, 0.000000);		prev.coeff(19, 0.000000);		prev.coeff(20, 0.000000);		prev.coeff(21, 0.000000);		prev.coeff(22, 0.000000);		prev.fVal(12.000000);
	}
